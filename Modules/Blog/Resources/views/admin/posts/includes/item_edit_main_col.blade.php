      ...
      <div class="tab-pane active">
        ...
        @forelse($locales as $locale)
          ...
          <div class="form-group">
            ...
            <textarea class="form-control content-editor_{{$locale->local}}" id="editor{{$loop->iteration}}" rows="10"
                      name="{{$content}}">
                                {{ $item->$content}}
                                    </textarea>
          </div>
          <div class="form-group">
            ...
            <textarea class="form-control description-editor" id="editor{{$loop->iteration + 10}}" rows="1"
