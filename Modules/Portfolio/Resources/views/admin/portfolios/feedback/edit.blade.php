...
@section('content')
    ...
    <section class="content card-body card">
        ...
        <form method="POST" action="{{route('site.admin.feedback.update', $item->id)}}" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="row">
                <div class="col-sm-8">
                    @forelse($locales as $locale)
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="editor_{{$locale->local}}" rows="9"
                ...
                <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label for="slug">@if($item->sreen) <img class="admin__img-head" src="{{$item->sreen}}" alt="{{$item->img_alt}}">
        ...
        <form method="post" onsubmit='return false' action="{{route('site.admin.feedback.destroy', $item->id)}}">
            @method('DELETE')
            @csrf
