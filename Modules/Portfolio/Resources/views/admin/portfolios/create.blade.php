...
@section('content')
    ...
    <div class="content-header">
        @component('site.admin.components.breadcrumb')
            @slot('title') {{__('admin.add')}} {{__('admin.portfolio')}}@endslot
            @slot('parent') {{__('admin.home')}} @endslot
            @slot('portfolios') {{__('admin.portfolio_filter')}} @endslot
            @slot('active') {{__('admin.add')}} {{__('admin.portfolio')}}@endslot
        @endcomponent
    ...
    <section class="content card-body card">
        ...
        <form method="POST" action="{{route('site.admin.portfolios.store', $item->id)}}" enctype="multipart/form-data">
