...
@section('content')
  ...
  <div class="content-header">
    @component('admin.components.breadcrumb')
      @slot('title') {{__('admin.add')}} {{__('portfolio::admin.portfolio')}}@endslot
      @slot('parent') {{__('admin.home')}} @endslot
      @slot('portfolios') {{__('portfolio::admin.portfolio_categories')}} @endslot
      @slot('active') {{__('admin.add')}} {{__('portfolio::admin.portfolio')}}@endslot
    @endcomponent
  </div>
  <!-- /.content-header -->
                ...
                <div class="tab-content">
                  <div class="tab-pane active">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control content-editor_{{$locale->local}}" id="editor{{$loop->iteration}}"
                                rows="10"
                                name="{{$content}}">
                                {{ $item->$content}}
                       </textarea>
        ...
        <div class="col-sm-4">
          ...
          <div class="parent_id form-group">
            ...
            <select type="text" name="portfolio_categories_id" value="{{$item->filter_id}}"
                    id="portfolio_categories_id" class="form-control" placeholder="Выберите категорию" required>
          ...
          <div class="form-group">
            <label for="title">{{__('portfolio::admin.time_site')}} {{__('portfolio::admin.project_s')}}</label>
