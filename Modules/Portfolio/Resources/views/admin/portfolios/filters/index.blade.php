...
@section('content')
    ...
    <div class="content-header">
        @component('site.admin.components.breadcrumb')
            @slot('title') {{__('admin.portfolio_filter')}} @endslot
            @slot('parent') {{__('admin.home')}} @endslot
            @slot('active') {{__('admin.portfolio_filter')}} @endslot
        @endcomponent
    ...
    <section class="content">
            ...
            <table class="table table-hover text-nowrap">
                ...
                @forelse($items as $item)
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-success" href="{{route('site.admin.filters.edit', $item->id )}}">{{__('admin.edit')}}</a>
                            </td>
                        </tr>
                    @empty
                    <tr>
        ...
        <a class="btn btn-outline-success btn-add" href="{{route('site.admin.filters.create')}}">{{__('admin.add')}}</a>
    </section>
